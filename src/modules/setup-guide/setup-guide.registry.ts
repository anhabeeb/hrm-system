...
export const SETUP_GUIDE_ACTIVITIES: SetupActivityDefinition[] = [
  ...
  core("employee_numbering", "Configure employee numbering", "/settings?section=numbering&setupGuide=employees&highlight=employee-numbering", "employee-numbering", "Choose a consistent employee numbering format before bulk onboarding.", "Employee numbering settings exist or have been manually confirmed."),
  core("feature_modules", "Review module availability", "/settings?setupGuide=modules&highlight=module-status-overview", "module-status-overview", "Review enabled and disabled modules here. To enable or disable a module, open that module's own settings page and use its Module Availability section.", "Module availability has been reviewed from the Module Status Overview and each module's settings page."),
  ...
  moduleActivity("asset_tracking", "asset_issue_rules", "Configure asset issue/return rules", "/settings/assets?section=issue-rules&setupGuide=assets&highlight=asset-issue-rules", "asset-issue-rules", "Review issue, return, and employee responsibility rules for company assets.", "Asset issue/return rules are reviewed."),
  ...
  moduleActivity("uniform_tracking", "uniform_issue_rules", "Configure uniform issue/return rules", "/settings/uniforms?section=issue-rules&setupGuide=uniforms&highlight=uniform-issue-rules", "uniform-issue-rules", "Review how uniforms are issued, returned, and tracked.", "Uniform issue/return rules are reviewed."),
  ...
  moduleActivity("leave_management", "leave_policy_rules", "Configure leave policy rules", "/settings/leave?section=policy-rules&setupGuide=leave&highlight=leave-policy-rules", "leave-policy-rules", "Set paid status, approval behavior, and document rules for each leave type.", "Leave policy rules are configured."),
  moduleActivity("leave_management", "leave_document_rules", "Configure leave document rules", "/settings/leave?section=document-rules&setupGuide=leave&highlight=leave-document-rules", "leave-document-rules", "Decide when each leave type requires supporting documents.", "Leave document rules are reviewed."),
  moduleActivity("leave_management", "leave_deduction_rules", "Configure leave deduction rules", "/settings/leave?section=deduction-rules&setupGuide=leave&highlight=leave-deduction-rules", "leave-deduction-rules", "Review which leave types create payroll deductions.", "Leave deduction rules are reviewed."),
  ...
  moduleActivity("employee_management", "self_service", "Configure self-service", "/settings?section=employee-access&setupGuide=self-service&highlight=self-service-settings", "self-service-settings", "Choose what linked employees can view or request from self-service.", "Self-service settings are reviewed."),
