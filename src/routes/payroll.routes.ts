...
payrollRoutes.get("/subfeatures", requireAnyPermission(["payroll.view", "payroll.calculate", "payroll.recalculate", "payroll.review", "payroll.approve", "payroll.finalize", "payroll.adjustments.view", "payslips.view", "advances.view", "salary_loans.view", "payroll_reports.view"]), controller.subFeatures);
...
payrollRoutes.post("/calculate", requirePayrollSubFeature("payroll.salary_processing_enabled"), requirePermission("payroll.calculate"), controller.calculate);
...
payrollRoutes.post("/adjustments", requirePayrollSubFeature("payroll.manual_deductions_enabled"), requireAnyPermission(["payroll.adjustments.create", "payroll.adjustments.createForOthers"]), controller.createAdjustment);
...
payrollRoutes.post("/adjustments/:id/approve", requirePayrollSubFeature("payroll.approvals_enabled"), requireAnyPermission(["payroll.adjustments.approve", "payroll.adjustments.review", "payroll.adjustments.finalApprove", "approvals.department.approve", "approvals.financeFinal.approve"]), requireReason(), controller.approveAdjustment);
payrollRoutes.post("/adjustments/:id/reject", requirePayrollSubFeature("payroll.approvals_enabled"), requireAnyPermission(["payroll.adjustments.reject", "approvals.department.reject", "approvals.financeFinal.reject"]), requireReason(), controller.rejectAdjustment);
...
payrollRoutes.post("/adjustments/:id/apply", requirePayrollSubFeature("payroll.manual_deductions_enabled"), requireAnyPermission(["payroll.adjustments.apply"]), requireReason(), controller.applyAdjustment);
...
payrollRoutes.post("/runs/:id/submit-approval", requirePayrollSubFeature("payroll.approvals_enabled"), requirePermission("payroll.review"), requireReason(), controller.submitApproval);
payrollRoutes.post("/runs/:id/approve", requirePayrollSubFeature("payroll.approvals_enabled"), requirePermission("payroll.approve"), requireReason(), controller.approve);
payrollRoutes.post("/runs/:id/reject", requirePayrollSubFeature("payroll.approvals_enabled"), requirePermission("payroll.reject"), requireReason(), controller.reject);
payrollRoutes.post("/runs/:id/finalize", requirePayrollSubFeature("payroll.salary_processing_enabled"), requirePermission("payroll.finalize"), requireReason(), controller.finalize);
payrollRoutes.get("/runs/:id/payslips", requireFeature("payslips"), requirePayrollSubFeature("payroll.payslips_enabled"), requirePermission("payslips.view"), payslipsController.listRunPayslips);
payrollRoutes.get("/runs/:id/payslips/:payslipId", requireFeature("payslips"), requirePayrollSubFeature("payroll.payslips_enabled"), requirePermission("payslips.view"), payslipsController.getRunPayslip);
payrollRoutes.get("/:id", requirePermission("payroll.view"), controller.getPayroll);
payrollRoutes.post("/:id/recalculate", requirePayrollSubFeature("payroll.salary_processing_enabled"), requirePermission("payroll.recalculate"), requireReason(), controller.recalculate);
...
payrollRoutes.post("/:id/submit-approval", requirePayrollSubFeature("payroll.approvals_enabled"), requirePermission("payroll.review"), requireReason(), controller.submitApproval);
payrollRoutes.post("/:id/approve", requirePayrollSubFeature("payroll.approvals_enabled"), requirePermission("payroll.approve"), requireReason(), controller.approve);
payrollRoutes.post("/:id/reject", requirePayrollSubFeature("payroll.approvals_enabled"), requirePermission("payroll.reject"), requireReason(), controller.reject);
payrollRoutes.post("/:id/finalize", requirePayrollSubFeature("payroll.salary_processing_enabled"), requirePermission("payroll.finalize"), requireReason(), controller.finalize);
