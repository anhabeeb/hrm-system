...
profileUpdateRequestsRoutes.get(
  "/",
  requireAnyPermission(["profile_updates.view", "profile_update_requests.view"]),
...
profileUpdateRequestsRoutes.post(
  "/:id/approve",
  requireAnyPermission(["profile_updates.review", "profile_update_requests.approve"]),
  requireReason({ fields: ["reason", "review_notes"] }),
  controller.approveRequest,
);
profileUpdateRequestsRoutes.post(
  "/:id/reject",
  requireAnyPermission(["profile_updates.review", "profile_update_requests.reject"]),
  requireReason({ fields: ["reason", "review_notes"] }),
  controller.rejectRequest,
);
profileUpdateRequestsRoutes.post(
  "/:id/return-for-more-info",
  requireAnyPermission(["profile_updates.review", "profile_update_requests.return_for_more_info"]),
  requireReason({ fields: ["reason", "review_notes"] }),
