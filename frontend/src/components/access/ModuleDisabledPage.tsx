  ...
  return (
    <div className="flex min-h-[55vh] items-center justify-center">
      <div className="max-w-md rounded-lg border bg-card p-6 text-center shadow-sm">
        ...
        <h1 className="mt-4 text-lg font-semibold">{MODULE_DISABLED_MESSAGE}</h1>
        <p className="mt-2 text-sm text-muted-foreground">{moduleName} is not available right now. Please contact your administrator if you need access.</p>
