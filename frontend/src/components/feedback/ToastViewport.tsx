    ...
    {toasts.map((toast) => {
      ...
      return (
        <div
          ...
          className={cn("pointer-events-auto rounded-xl border p-4 text-sm shadow-lg", styles[toast.type])}
        >
          <div className="flex gap-3">
            ...
            <Button
              ...
              className="-mr-2 -mt-2 h-7 w-7 shrink-0 text-slate-500 hover:text-slate-900"
              size="icon"
              type="button"
              variant="ghost"
