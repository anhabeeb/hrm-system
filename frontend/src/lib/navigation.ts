...
export const navigationGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Kiosk Devices", path: "/kiosk-devices", icon: TabletSmartphone, moduleCodesAll: ["attendance", "kiosk"], requiredFeaturesAll: ["attendance", "offline_sync"], requiredPermissionsAny: ["devices.view", "kiosk.view"] },
      { label: "Sync Status", path: "/sync-status", icon: Repeat, requiredFeature: "offline_sync", requiredPermission: "sync.view" },
      { label: "Biometric", path: "/biometric", icon: Fingerprint, moduleCodesAll: ["attendance", "biometric"], requiredFeaturesAll: ["attendance", "biometric_attendance"], requiredPermission: "biometric.view" },
    ],
  },
  {
    label: "Leave & Payroll",
