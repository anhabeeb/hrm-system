...
export const navigationGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Contracts", path: "/contracts", icon: FileSignature, moduleCodesAll: ["employees", "contract_tracking"], requiredFeaturesAll: ["employee_management", "contract_tracking"], requiredPermissionsAny: ["contracts.view", "employees.contracts.view", "employees.view"] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "attendance-corrections", label: "Time Corrections", path: "/attendance/corrections", icon: FileClock, requiredFeature: "attendance", requiredAttendanceSubFeature: "corrections_enabled", requiredPermission: "attendance.view", badgeKey: "attendanceCorrections" },
      ...
      { label: "Kiosk Devices", path: "/kiosk-devices", icon: TabletSmartphone, moduleCodesAll: ["attendance", "kiosk"], requiredFeaturesAll: ["attendance", "offline_sync"], requiredAttendanceSubFeature: "kiosk_enabled", requiredPermissionsAny: ["devices.view", "kiosk.view"] },
      { label: "Sync Status", path: "/sync-status", icon: Repeat, requiredFeature: "offline_sync", requiredPermission: "sync.view" },
      { label: "Biometric", path: "/biometric", icon: Fingerprint, moduleCodesAll: ["attendance", "biometric"], requiredFeaturesAll: ["attendance", "biometric_attendance"], requiredAttendanceSubFeature: "biometric_enabled", requiredPermission: "biometric.view" },
    ],
  },
  {
    label: "Leave & Payroll",
    items: [
      ...
      { id: "payroll-attendance-review", label: "Payroll Attendance Review", path: "/payroll/attendance-review", icon: CalendarDays, moduleCode: "payroll", moduleCodesAll: ["payroll", "attendance"], requiredFeature: "payroll", requiredFeaturesAll: ["payroll", "attendance"], requiredPayrollSubFeature: "attendance_deductions_enabled", requiredAttendanceSubFeature: "payroll_deductions_enabled", requiredPermissionsAny: ["payroll.attendanceReview.view", "payroll.view"] },
      { label: "Payslips", path: "/payslips", icon: ReceiptText, moduleCodesAll: ["payroll", "payslips"], requiredFeaturesAll: ["payroll", "payslips"], requiredPayrollSubFeature: "payslips_enabled", requiredPermission: "payslips.view" },
      { label: "Advances", path: "/advances", icon: WalletCards, moduleCodesAll: ["payroll", "advance_salary"], requiredFeaturesAll: ["payroll", "advance_salary"], requiredPayrollSubFeature: "advances_enabled", requiredPermission: "advances.view" },
      { label: "Salary Loans", path: "/salary-loans", icon: Banknote, moduleCode: "payroll", requiredFeature: "payroll", requiredPayrollSubFeature: "salary_loans_enabled", requiredPermission: "salary_loans.view" },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Payroll / Finance Reports", path: "/payroll-reports", icon: Landmark, moduleCodesAll: ["reports", "payroll"], requiredFeaturesAll: ["reports", "payroll"], requiredPermissionsAny: ["payroll_reports.view", "payroll_reports.catalog.view"] },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Asset Tracking", path: "/settings/assets", icon: PackageCheck, requiredFeature: "settings", requiredPermissionsAny: ["assets_settings.manage", "settings.view"] },
      { label: "Uniform Tracking", path: "/settings/uniforms", icon: Shirt, requiredFeature: "settings", requiredPermissionsAny: ["assets_settings.manage", "settings.view"] },
      { label: "Duty Roster", path: "/settings/roster", icon: CalendarDays, requiredFeature: "settings", requiredPermissionsAny: ["roster_settings.manage", "settings.view"] },
      { label: "Contract Tracking", path: "/settings/contracts", icon: FileSignature, requiredFeature: "settings", requiredPermissionsAny: ["documents_settings.manage", "settings.view"] },
