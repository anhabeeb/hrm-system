...
export const ImportExportPage = () => {
  ...
  const [reasonAction, setReasonAction] = useState<"cancelExport" | "retryExport" | "validateImport" | "cancelImport" | null>(null);
