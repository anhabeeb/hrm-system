    ...
    sections: [
      {
        ...
        fields: [
          { key: "late_grace_minutes", label: "Grace period minutes", type: "number" },
          { key: "late_threshold_minutes", label: "Late threshold minutes", type: "number" },
          { key: "early_out_grace_minutes", label: "Early checkout threshold minutes", type: "number" },
          { key: "default_shift_duration_hours", label: "Default shift duration hours", type: "number" },
        ],
      },
      {
        ...
        fields: [
          ...
          { key: "attendance_correction_approval_required", label: "Correction approval required", type: "switch" },
          ...
          { key: "require_reason_for_manual_attendance", label: "Require reason for manual attendance", type: "switch" },
        ],
      },
      {
        ...
        fields: [
          ...
          { key: "overtime_enabled", label: "Overtime enabled", type: "switch" },
          { key: "overtime_approval_required", label: "Overtime approval required", type: "switch" },
        ],
      },
    ],
  },
