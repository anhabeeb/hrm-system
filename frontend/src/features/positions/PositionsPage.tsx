    ...
    <div>
      <div className="space-y-4 p-4 md:p-6">
        ...
        <div className="flex flex-wrap items-center justify-end gap-2">
          {canCreate ? <Button data-setup-target="position-create-button" onClick={() => { setSelected(null); setError(null); setFormOpen(true); }}><BadgeCheck className="h-4 w-4" /> Create Position</Button> : null}
        </div>
        ...
        <div data-setup-target="positions-list">
          <DataTable
            compact
