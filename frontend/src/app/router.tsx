...
import { AuditLogsPlaceholderPage } from "@/features/audit/AuditLogsPlaceholderPage";
  ...
  <Routes>
    ...
    <Route element={<ProtectedRoute />}>
      <Route element={<AppShell />}>
        ...
        <Route path="/audit-logs" element={guarded(<AuditLogsPlaceholderPage />, { permission: "audit_logs.view", feature: "audit_logs" })} />
