  ...
  <Routes>
    ...
    <Route element={<ProtectedRoute />}>
      <Route element={<AppShell />}>
        ...
        <Route path="/contracts" element={guarded(<ContractsPage />, { permissionsAny: ["contracts.view", "employees.contracts.view", "employees.view"], featuresAll: ["employee_management", "contract_tracking"], moduleCodesAll: ["employees", "contract_tracking"], moduleName: "Contract Tracking" })} />
